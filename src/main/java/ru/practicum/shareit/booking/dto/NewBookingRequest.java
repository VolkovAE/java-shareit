...
import ru.practicum.shareit.validation.DateInPast;
...
public class NewBookingRequest {
    ...
    @DateInPast(message = "Дата начала бронирования не может быть в прошлом.")
    ...
    @NotNull(message = "При создании запроса должен быть указан конец периода аренды.",
            groups = Marker.OnCreate.class)
    @DateInPast(message = "Дата конца бронирования не может быть в прошлом.")
